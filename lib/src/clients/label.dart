...
class Label {
  ...
  /// - [inc]: Additional details to include: `aliases` `annotation` `tags` `releases` `genres` `ratings` `area-rels` `artist-rels` `event-rels` `genre-rels` `instrument-rels` `label-rels` `place-rels` `recording-rels` `release-rels` `release-group-rels` `series-rels` `url-rels` `work-rels`
  ///
